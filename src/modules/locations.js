...
export const LOCATIONS = [
    ...
    // ── Cities ───────────────────────────────────
    // `country` enables reverse geocoding to return "City, Country"
    { name: `London`, country: `United Kingdom`, lat: 51.51, lng: -0.13, type: `city` },
    { name: `Paris`, country: `France`, lat: 48.86, lng: 2.35, type: `city` },
    { name: `Berlin`, country: `Germany`, lat: 52.52, lng: 13.41, type: `city` },
    { name: `Madrid`, country: `Spain`, lat: 40.42, lng: -3.70, type: `city` },
    { name: `Rome`, country: `Italy`, lat: 41.90, lng: 12.50, type: `city` },
    { name: `Amsterdam`, country: `Netherlands`, lat: 52.37, lng: 4.90, type: `city` },
    { name: `Stockholm`, country: `Sweden`, lat: 59.33, lng: 18.07, type: `city` },
    { name: `Oslo`, country: `Norway`, lat: 59.91, lng: 10.75, type: `city` },
    { name: `Helsinki`, country: `Finland`, lat: 60.17, lng: 24.94, type: `city` },
    { name: `Athens`, country: `Greece`, lat: 37.98, lng: 23.73, type: `city` },
    { name: `Istanbul`, country: `Turkey`, lat: 41.01, lng: 28.98, type: `city` },
    { name: `Moscow`, country: `Russia`, lat: 55.76, lng: 37.62, type: `city` },
    { name: `Lisbon`, country: `Portugal`, lat: 38.72, lng: -9.14, type: `city` },
    { name: `Vienna`, country: `Austria`, lat: 48.21, lng: 16.37, type: `city` },
    { name: `Zurich`, country: `Switzerland`, lat: 47.38, lng: 8.54, type: `city` },
    { name: `Warsaw`, country: `Poland`, lat: 52.23, lng: 21.01, type: `city` },
    { name: `Prague`, country: `Czech Republic`, lat: 50.08, lng: 14.44, type: `city` },
    { name: `Budapest`, country: `Hungary`, lat: 47.50, lng: 19.04, type: `city` },
    { name: `Dublin`, country: `Ireland`, lat: 53.35, lng: -6.26, type: `city` },
    { name: `Brussels`, country: `Belgium`, lat: 50.85, lng: 4.35, type: `city` },
    { name: `Copenhagen`, country: `Denmark`, lat: 55.68, lng: 12.57, type: `city` },
    { name: `New York`, country: `United States`, lat: 40.71, lng: -74.01, type: `city` },
    { name: `Chicago`, country: `United States`, lat: 41.88, lng: -87.63, type: `city` },
    { name: `Denver`, country: `United States`, lat: 39.74, lng: -104.99, type: `city` },
    { name: `Los Angeles`, country: `United States`, lat: 34.05, lng: -118.24, type: `city` },
    { name: `Toronto`, country: `Canada`, lat: 43.65, lng: -79.38, type: `city` },
    { name: `Mexico City`, country: `Mexico`, lat: 19.43, lng: -99.13, type: `city` },
    { name: `São Paulo`, country: `Brazil`, lat: -23.55, lng: -46.63, type: `city` },
    { name: `Buenos Aires`, country: `Argentina`, lat: -34.60, lng: -58.38, type: `city` },
    { name: `Bogotá`, country: `Colombia`, lat: 4.71, lng: -74.07, type: `city` },
    { name: `Lima`, country: `Peru`, lat: -12.05, lng: -77.04, type: `city` },
    { name: `Santiago`, country: `Chile`, lat: -33.45, lng: -70.67, type: `city` },
    { name: `Anchorage`, country: `United States`, lat: 61.22, lng: -149.90, type: `city` },
    { name: `Honolulu`, country: `United States`, lat: 21.31, lng: -157.86, type: `city` },
    { name: `Tokyo`, country: `Japan`, lat: 35.68, lng: 139.69, type: `city` },
    { name: `Shanghai`, country: `China`, lat: 31.23, lng: 121.47, type: `city` },
    { name: `Hong Kong`, country: `China`, lat: 22.32, lng: 114.17, type: `city` },
    { name: `Singapore`, country: `Singapore`, lat: 1.35, lng: 103.82, type: `city` },
    { name: `Dubai`, country: `UAE`, lat: 25.20, lng: 55.27, type: `city` },
    { name: `Kolkata`, country: `India`, lat: 22.57, lng: 88.36, type: `city` },
    { name: `Seoul`, country: `South Korea`, lat: 37.57, lng: 126.98, type: `city` },
    { name: `Bangkok`, country: `Thailand`, lat: 13.76, lng: 100.50, type: `city` },
    { name: `Jakarta`, country: `Indonesia`, lat: -6.21, lng: 106.85, type: `city` },
    { name: `Taipei`, country: `Taiwan`, lat: 25.03, lng: 121.57, type: `city` },
    { name: `Manila`, country: `Philippines`, lat: 14.60, lng: 120.98, type: `city` },
    { name: `Karachi`, country: `Pakistan`, lat: 24.86, lng: 67.01, type: `city` },
    { name: `Tehran`, country: `Iran`, lat: 35.69, lng: 51.39, type: `city` },
    { name: `Riyadh`, country: `Saudi Arabia`, lat: 24.71, lng: 46.67, type: `city` },
    { name: `Cairo`, country: `Egypt`, lat: 30.04, lng: 31.24, type: `city` },
    { name: `Lagos`, country: `Nigeria`, lat: 6.52, lng: 3.38, type: `city` },
    { name: `Johannesburg`, country: `South Africa`, lat: -26.20, lng: 28.04, type: `city` },
    { name: `Nairobi`, country: `Kenya`, lat: -1.29, lng: 36.82, type: `city` },
    { name: `Casablanca`, country: `Morocco`, lat: 33.57, lng: -7.59, type: `city` },
    { name: `Sydney`, country: `Australia`, lat: -33.87, lng: 151.21, type: `city` },
    { name: `Melbourne`, country: `Australia`, lat: -37.81, lng: 144.96, type: `city` },
    { name: `Auckland`, country: `New Zealand`, lat: -36.85, lng: 174.76, type: `city` },
]
